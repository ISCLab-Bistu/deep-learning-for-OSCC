...
class Ml4fTransformer(nn.Module):
    ...
    def __init__(self, inp_dim_e, inp_dim_d, experiment='return', d_model=256,
                 dff=256, N_e=1, N_d=1, heads=4, dropout=0.5, pe_window=12):
        super().__init__()

        # assert d_model % heads == 0

        self.encoder = Encoder_t(N_e, 1044, heads, inp_dim_e, d_model, dff, dropout=dropout)


        self.linear_fusion = nn.Linear(1044, 6)
